      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="glass-card rounded-xl p-6 text-center border border-[#1A1A1A]">
          ...
          <form onSubmit={handleSubmit} className="glass-card rounded-xl p-6 border border-[#1A1A1A]">
            ...
            <Button 
              type="submit" 
              className="mt-4 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white px-8 py-6 text-lg rounded-full shadow-lg shadow-blue-500/20 hover:shadow-purple-500/40 transition-all duration-300"
            >
              Send Message
            </Button>
          </form>
